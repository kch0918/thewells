...
<head>
	...
	<meta property="og:title" content="The Wells Investment"/>
	...
	<meta name="twitter:title" content="The Wells Investment">
				...
				<div id="gnb" class="gnb inb">
					<div class="gnb-wr fz0">
						<div class="gnb-box inb fz0 pc">
							<ul class="dep1">
								<li>
									<a href="/aboutus/philosophy_en" class="anchor-ab"><span>About Us</span></a>
									<ul class="dep2-wr pc">
										<li class="dep2"><a href="/aboutus/philosophy_en">Philosophy</a></li>
										<li class="dep2"><a href="/aboutus/history_en">History</a></li>
										<li class="dep2 dis-no"><a href="/aboutus/stewardship">Stewardship Code</a></li>
									</ul>
								</li>
								<li class="short">
									<a href="/partners/all_en" class="anchor-pa"><span>Partners</span></a>
									<ul class="dep2-wr pc dn">
										<li class="dep2"><a href="/partners/all_en">All</a></li>
										<c:forEach items="${ptnr_cate}" var="i">
										<li class="dep2"><a href="/partners/all_en">${i.cate_nm} </a></li>
										</c:forEach>
									</ul>
								</li>
								<li class="short">
									<a href="/team/all_en" class="anchor-te"><span>Team</span></a>
									<ul class="dep2-wr pc dn">
										<li class="dep2"><a href="/team/all_en">All </a></li>
										<c:forEach items="${team_cate}" var="i">
										<li class="dep2"><a href="/team/all_en">${i.cate_nm}</a></li>
										</c:forEach>
									</ul>
								</li>
								<li class="short dis-no">
						...
						<ul class="nav dep1-wr">
							...
							<li class="dep1 team" data-img="/img/header/lnb-team.png">
								...
								<ul id="team_cate" class="dep2-wr">
										<li class="dep2"><a href="/team/all_en">All </a></li>
									<c:forEach items="${team_cate}" var="i">
										<li class="dep2"><a href="/team/all_en?cate_idx=${i.idx}">${i.cate_nm_en}</a></li>
									</c:forEach>
								</ul>
							</li>
							<li class="dep1 partners" data-img="/img/header/lnb-partners.png">
								<a href="/partners/all_en">
								...
								<ul class="dep2-wr">
									<li class="dep2"><a href="/partners/all_en">All</a></li>
									<c:forEach items="${ptnr_cate}" var="i">
										<li class="dep2"><a href="/partners/all_en?cate_idx=${i.idx}">${i.cate_nm} </a></li>
									</c:forEach>
								</ul>
							</li>
							<li class="dep1 news dis-no" data-img="/img/header/lnb-news.png">
								<a href="/news/all">
