...
function getList(){
	$.ajax({
		type : "POST", 
		url : "/admin/team/getTeamCateList",
		dataType : "text",
		async : false,
		error : function() 
		{
		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				...
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner2 += '		<input type="button" value="카테고리 삭제" class="del_btn" onclick="delTeamCate(\''+result.list[i].idx+'\')">';
					inner2 += '	</div>';
					inner2 +='</div>';
...
//카테고리 추가
function insTeamCate()
{
	$.ajax({
		type : "POST", 
		url : "/admin/team/insTeamCate",
		dataType : "text",
		async : false,
		data : 
		{
	...
	<div class="top_cont">
		<div class="info_txt">
			<ul>
				...
				<li class="inb"><a href="/admin/team/team_cate">카테고리 관리</a></li>
			</ul>
			    ...
			    <div class="cate-left inb">
			    	<div class="category-btn">
				         <ul>
				            ...
				            <li class="inb"><button onclick="javascript:insTeamCate();" class="small-btn"></button></li>
				        </ul>
				    </div>
